...
function Rules() {
	return (
		...
		<p><strong>2&nbsp;&nbsp;Temperament.&mdash;</strong> You shall employ an ideal attitude, contribute positively, and not be rude, disrespectful, or a nuisance.</p>

		<p><strong>3&nbsp;&nbsp;What You Share.&mdash;</strong> No sort of inappropriate content (that is not safe-for-work) shall be posted in this server. You shall stay appropriate with your chats, the content you post, or that you display in your Discord account.</p>

		<p><strong>4&nbsp;&nbsp;Channels.&mdash;</strong> The channels shall be used for their intended purpose. Refer to <code>#welcome</code> when in doubt about why a channel/role exists.</p>
